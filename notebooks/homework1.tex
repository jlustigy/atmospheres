...
{\color{incolor}In [{\color{incolor}1}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
        ...
        \PY{k+kn}{import} \PY{n+nn}{scipy.optimize}
        ...
        \PY{n}{mpl}\PY{o}{.}\PY{n}{rcParams}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{font.size}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+m+mf}{25.0}
        \PY{n}{rc}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{text}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{usetex}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{astropy.units} \PY{k+kn}{as} \PY{n+nn}{u}
\end{Verbatim}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Known quantities}
         \PY{n}{T200} \PY{o}{=} \PY{l+m+mf}{273.16} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}
         \PY{n}{P200} \PY{o}{=} \PY{l+m+mf}{200.0} \PY{o}{*} \PY{l+m+mf}{1e\PYZhy{}3} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{bar}
         \PY{n}{Tsurf} \PY{o}{=} \PY{l+m+mf}{546.32} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}
         
         \PY{c+c1}{\PYZsh{} Define gram/mol unit}
         \PY{n}{amu} \PY{o}{=} \PY{n}{u}\PY{o}{.}\PY{n}{gram} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{mol}
         
         \PY{c+c1}{\PYZsh{} Masses of atoms in grams/mol}
         \PY{n}{mmw\PYZus{}Xe} \PY{o}{=} \PY{l+m+mf}{130.} \PY{o}{*} \PY{n}{amu}
         ...
         \PY{c+c1}{\PYZsh{} Mass of methane}
         \PY{n}{mmw\PYZus{}CH4} \PY{o}{=} \PY{n}{mmw\PYZus{}C} \PY{o}{+} \PY{l+m+mi}{4}\PY{o}{*}\PY{n}{mmw\PYZus{}H}
         
         \PY{c+c1}{\PYZsh{} Mass of Lead Tetraethyl}
         \PY{n}{mmw\PYZus{}PbTet} \PY{o}{=} \PY{n}{mmw\PYZus{}Pb} \PY{o}{+} \PY{l+m+mi}{4}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{mmw\PYZus{}C}\PY{o}{+}\PY{l+m+mi}{5}\PY{o}{*}\PY{n}{mmw\PYZus{}H}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{} Heat capacity Cv = (R/2) * DOF}
         \PY{c+c1}{\PYZsh{} where DOF\PYZti{} 3*(number of atoms)}
         \PY{n}{Cv\PYZus{}Xe} \PY{o}{=} \PY{l+m+mf}{0.5} \PY{o}{*} \PY{l+m+mf}{3.}
         \PY{n}{Cv\PYZus{}CH4} \PY{o}{=} \PY{l+m+mf}{0.5} \PY{o}{*} \PY{p}{(}\PY{l+m+mf}{3.} \PY{o}{*} \PY{l+m+mf}{5.}\PY{p}{)}
         \PY{n}{Cv\PYZus{}PbTet} \PY{o}{=} \PY{l+m+mf}{0.5} \PY{o}{*} \PY{p}{(}\PY{l+m+mf}{3.} \PY{o}{*} \PY{l+m+mf}{29.}\PY{p}{)}
         \PY{n}{Cv\PYZus{}He} \PY{o}{=} \PY{l+m+mf}{0.5} \PY{o}{*} \PY{l+m+mf}{3.}
\end{Verbatim}
...
\[ P = P_{ref} \left ( \frac{T}{T_{ref}} \right ) ^{1+\frac{N_{dof}}{2}} \]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}162}]:} \PY{k}{def} \PY{n+nf}{P1}\PY{p}{(}\PY{n}{T}\PY{p}{,} \PY{n}{Pr}\PY{p}{,} \PY{n}{Tr}\PY{p}{,} \PY{n}{Ndof}\PY{p}{)}\PY{p}{:}
          ...
          \PY{l+s+sd}{    P1 : Pressure are given T}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
...
mixing ratios.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}163}]:} \PY{c+c1}{\PYZsh{} Set the number of atoms for each gas}
...
atmosphere, we calculate the surface pressures given below:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{Pi} \PY{o}{=} \PY{n}{P1}\PY{p}{(}\PY{n}{Tsurf}\PY{p}{,} \PY{n}{P200}\PY{p}{,} \PY{n}{T200}\PY{p}{,} \PY{n}{Ndof1}\PY{p}{)}
...
Surface pressure for case (i) is 9.05096679919 bar
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{Pii} \PY{o}{=} \PY{n}{P1}\PY{p}{(}\PY{n}{Tsurf}\PY{p}{,} \PY{n}{P200}\PY{p}{,} \PY{n}{T200}\PY{p}{,} \PY{n}{Ndof2}\PY{p}{)}
...
Surface pressure for case (ii) is 4.97582161916e+12 bar
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{Piii} \PY{o}{=} \PY{n}{P1}\PY{p}{(}\PY{n}{Tsurf}\PY{p}{,} \PY{n}{P200}\PY{p}{,} \PY{n}{T200}\PY{p}{,} \PY{n}{Ndof3}\PY{p}{)}
...
\[ H = \frac{k \bar{T}}{\bar{m} g } \]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{n}{k} \PY{o}{=} \PY{l+m+mf}{1.38064852e\PYZhy{}23} \PY{o}{*} \PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{*}\PY{n}{u}\PY{o}{.}\PY{n}{kg} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{second}\PY{o}{*}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}\PY{o}{*}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{kg}\PY{o}{.}\PY{n}{in\PYZus{}units}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{g}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{g}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{kg}\PY{p}{)}\PY{p}{;} \PY{n}{k}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}73}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{k}{def} \PY{n+nf}{pressure\PYZus{}scale\PYZus{}height}\PY{p}{(}\PY{n}{T}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{g}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{n}{k}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{g} \PY{o}{=} \PY{l+m+mf}{9.8} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{s}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{;} \PY{n}{g}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}29}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{NA} \PY{o}{=} \PY{l+m+mf}{6.022140857e23} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{mol}\PY{o}{*}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{;} \PY{n}{NA}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}38}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}128}]:} \PY{n}{mu1} \PY{o}{=} \PY{p}{(}\PY{n}{fXe} \PY{o}{*} \PY{n}{mmw\PYZus{}Xe} \PY{o}{+} \PY{n}{fCH4} \PY{o}{*} \PY{n}{mmw\PYZus{}CH4}\PY{p}{)}\PY{p}{;} \PY{n}{mu1}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}128}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}132}]:} \PY{n}{mu2} \PY{o}{=} \PY{p}{(}\PY{n}{fPbTet} \PY{o}{*} \PY{n}{mmw\PYZus{}PbTet}\PY{p}{)}\PY{p}{;} \PY{n}{mu2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}132}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}131}]:} \PY{n}{mu3} \PY{o}{=} \PY{p}{(}\PY{n}{fHe} \PY{o}{*} \PY{n}{mmw\PYZus{}He} \PY{o}{+} \PY{n}{fCH4} \PY{o}{*} \PY{n}{mmw\PYZus{}CH4}\PY{p}{)}\PY{p}{;} \PY{n}{mu3}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}131}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}133}]:} \PY{n}{m1} \PY{o}{=} \PY{n}{mu1} \PY{o}{/} \PY{n}{NA}\PY{p}{;} \PY{n}{m1}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}133}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}134}]:} \PY{n}{m2} \PY{o}{=} \PY{n}{mu2} \PY{o}{/} \PY{n}{NA}\PY{p}{;} \PY{n}{m2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}134}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}135}]:} \PY{n}{m3} \PY{o}{=} \PY{n}{mu3} \PY{o}{/} \PY{n}{NA}\PY{p}{;} \PY{n}{m3}
\end{Verbatim}
...
\emph{above} 200 mbar.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}136}]:} \PY{n}{H1} \PY{o}{=} \PY{n}{pressure\PYZus{}scale\PYZus{}height}\PY{p}{(}\PY{n}{T200}\PY{p}{,} \PY{n}{m1}\PY{p}{,} \PY{n}{g}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{o}{.}\PY{n}{in\PYZus{}units}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{p}{;} \PY{n}{H1}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}136}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}137}]:} \PY{n}{H2} \PY{o}{=} \PY{n}{pressure\PYZus{}scale\PYZus{}height}\PY{p}{(}\PY{n}{T200}\PY{p}{,} \PY{n}{m2}\PY{p}{,} \PY{n}{g}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{o}{.}\PY{n}{in\PYZus{}units}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{p}{;} \PY{n}{H2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}137}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}138}]:} \PY{n}{H3} \PY{o}{=} \PY{n}{pressure\PYZus{}scale\PYZus{}height}\PY{p}{(}\PY{n}{T200}\PY{p}{,} \PY{n}{m3}\PY{p}{,} \PY{n}{g}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{o}{.}\PY{n}{in\PYZus{}units}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{p}{;} \PY{n}{H3}
\end{Verbatim}
...
Here's what we know:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}67}]:} \PY{n}{P2} \PY{o}{=} \PY{l+m+mf}{1.0} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{bar}\PY{p}{;} \PY{n}{P2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}67}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}146}]:} \PY{n}{T2} \PY{o}{=} \PY{l+m+mf}{60.} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}\PY{p}{;} \PY{n}{T2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}146}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}82}]:} \PY{n}{m\PYZus{}payload} \PY{o}{=} \PY{l+m+mf}{30.0} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{kg}\PY{p}{;} \PY{n}{m\PYZus{}payload} 
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}82}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}71}]:} \PY{n}{T\PYZus{}hot\PYZus{}air} \PY{o}{=} \PY{l+m+mf}{100.0} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}\PY{p}{;} \PY{n}{T\PYZus{}hot\PYZus{}air}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}71}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{n}{mu\PYZus{}Nep} \PY{o}{=} \PY{l+m+mf}{2.6} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{g}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{mol}\PY{p}{;} \PY{n}{mu\PYZus{}Nep}
\end{Verbatim}
...
Inside the balloon the density is:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}144}]:} \PY{n}{rho\PYZus{}in} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{n}{mu\PYZus{}Nep} \PY{o}{/} \PY{n}{NA}\PY{p}{)} \PY{o}{*} \PY{n}{P2}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{k} \PY{o}{*} \PY{n}{T\PYZus{}hot\PYZus{}air}\PY{p}{)}\PY{p}{;} \PY{n}{rho\PYZus{}in} 
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}144}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}147}]:} \PY{n}{rho\PYZus{}out} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{n}{mu\PYZus{}Nep} \PY{o}{/} \PY{n}{NA}\PY{p}{)} \PY{o}{*} \PY{n}{P2}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{k} \PY{o}{*} \PY{n}{T2}\PY{p}{)}\PY{p}{;} \PY{n}{rho\PYZus{}out}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}147}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}159}]:} \PY{n}{V} \PY{o}{=} \PY{n}{m\PYZus{}payload} \PY{o}{/} \PY{p}{(}\PY{n}{rho\PYZus{}out} \PY{o}{\PYZhy{}} \PY{n}{rho\PYZus{}in}\PY{p}{)}\PY{p}{;} \PY{n}{V}
\end{Verbatim}
...
\[ V = \frac{4}{3} \pi R^3 \rightarrow R = \left ( \frac{3V}{4 \pi} \right ) ^{1/3}\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}161}]:} \PY{n}{R} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{l+m+mf}{3.} \PY{o}{*} \PY{n}{V}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mf}{4.} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mf}{1.}\PY{o}{/}\PY{l+m+mf}{3.}\PY{p}{)}\PY{p}{;} \PY{n}{R}
\end{Verbatim}
...
Starting the isothermal temperature of
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}169}]:} \PY{n}{T3} \PY{o}{=} \PY{l+m+mi}{90} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{K}\PY{p}{;} \PY{n}{T3}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}169}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}165}]:} \PY{n}{muH2} \PY{o}{=} \PY{l+m+mf}{2.0} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{g} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{mol}\PY{p}{;} \PY{n}{muH2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}165}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}166}]:} \PY{n}{mH2} \PY{o}{=} \PY{n}{muH2} \PY{o}{/} \PY{n}{NA}\PY{p}{;} \PY{n}{mH2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}166}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}167}]:} \PY{n}{g\PYZus{}titan} \PY{o}{=} \PY{l+m+mf}{1.37} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{second}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{;} \PY{n}{g\PYZus{}titan}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}167}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}171}]:} \PY{n}{H3} \PY{o}{=} \PY{n}{pressure\PYZus{}scale\PYZus{}height}\PY{p}{(}\PY{n}{T3}\PY{p}{,} \PY{n}{mH2}\PY{p}{,} \PY{n}{g\PYZus{}titan}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{o}{.}\PY{n}{in\PYZus{}units}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{o}{/}\PY{n}{u}\PY{o}{.}\PY{n}{m}\PY{p}{;} \PY{n}{H3}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}171}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}172}]:} \PY{n}{R\PYZus{}titan} \PY{o}{=} \PY{l+m+mf}{2576.} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{km}\PY{p}{;} \PY{n}{R\PYZus{}titan}
\end{Verbatim}
...
pressure scale height would have been
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}175}]:} \PY{n}{H3} \PY{o}{/} \PY{n}{R\PYZus{}titan} \PY{o}{*} \PY{l+m+mi}{100} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{percent}
\end{Verbatim}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}189}]:} \PY{n}{atm} \PY{o}{=} \PY{l+m+mf}{1.01325} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{bar}\PY{p}{;} \PY{n}{atm}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}189}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}193}]:} \PY{n}{Nc} \PY{o}{=} \PY{l+m+mf}{8000.} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{cm}\PY{o}{*} \PY{n}{atm} \PY{p}{;}\PY{n}{Nc}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}193}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}185}]:} \PY{n}{muCO2} \PY{o}{=} \PY{l+m+mf}{44.} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{g} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{mol}\PY{p}{;} \PY{n}{muCO2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}185}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}187}]:} \PY{n}{mCO2} \PY{o}{=} \PY{n}{muCO2} \PY{o}{/} \PY{n}{NA}\PY{p}{;} \PY{n}{mCO2}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}187}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}186}]:} \PY{n}{g\PYZus{}mars} \PY{o}{=} \PY{l+m+mf}{3.72} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{m} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{second}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{;} \PY{n}{g\PYZus{}mars}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}186}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}181}]:} \PY{n}{n0} \PY{o}{=} \PY{l+m+mf}{2.687e19} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{cm}\PY{o}{*}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{l+m+mi}{3}\PY{p}{;} \PY{n}{n0}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}181}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}210}]:} \PY{n}{p\PYZus{}mars} \PY{o}{=} \PY{n}{Nc}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{n0}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{mCO2}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{g\PYZus{}mars}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}\PY{p}{;} \PY{n}{p\PYZus{}mars}
\end{Verbatim}
...
\texttt{\color{outcolor}Out[{\color{outcolor}188}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}191}]:} \PY{n}{Nc}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}191}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}195}]:} \PY{n}{p\PYZus{}mars}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
doesn't have the correct units. The RHS has units of pressure squared. I
think the correct equation should be:
...
Using this expression we get:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}213}]:} \PY{n}{p\PYZus{}mars} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{p}{(}\PY{n}{n0} \PY{o}{*} \PY{n}{Nc}\PY{p}{)}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{g\PYZus{}mars}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{mCO2}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{;} \PY{n}{p\PYZus{}mars}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}213}]:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}230}]:} \PY{n}{ppp} \PY{o}{=} \PY{p}{(}\PY{n}{p\PYZus{}mars} \PY{o}{/} \PY{n}{u}\PY{o}{.}\PY{n}{bar}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{decompose}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{bar}\PY{p}{;} \PY{n}{ppp}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}230}]:}
...
Since the true surface pressure to the CO\(_2\)-dominated Martian
...
geometry and a 2D integral over the visible disk of Mars.
